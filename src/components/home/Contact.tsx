      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-24">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-lg md:text-xl text-brand-text mb-8 leading-relaxed">Every engagement begins with a structured 45-minute consultation. We'll assess your current model, identify revenue leakage, and map out a growth architecture.</p>
